...
export class NegociacaoController {
    ...
    async importaNegociacoes() {
        ...
        try {
            // Isola o código de 'NegociacaoService' em um novo bundle, para trabalhar com lazy loading, 
            // o código isolado não pode ter o import estático em nenhum lugar.
            // System.import() é definido pelo webpack, novas versões do EcmaScript usam apenas o import().
